...
(a)
```{r}
log_variable <- log(1 + select(data, hamatop, hamabot))
hist(log_variable$hamatop, xlab = "mol/m2/s", ylab = "counts", main = "Incident PAR")
hist(log_variable$hamabot, xlab = "mol/m2/2", ylab = "counts", main = "Reflected PAR")
```
...
library(reshape2)
# humid
humid.height.mean <- data[data$Day == "May 26", ] %>%
...
# temperature
temp.height.mean <- data[data$Day == "May 26", ] %>%
...
# hamatop
hamatop.height.mean <- data[data$Day == "May 26", ] %>%
...
# hamabot
hamabot.height.mean <- data[data$Day == "May 26", ] %>%
